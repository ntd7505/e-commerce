    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500">Configure admin-facing defaults. These values are stored locally until backend settings APIs exist.</p>
        </div>
        <button
          type="button"
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-[1fr_360px]">
        <div className="space-y-6">
          <section className="rounded-2xl border border-slate-100 bg-white">
            <div className="border-b border-slate-100 px-6 py-4">
              <h3 className="font-bold text-slate-900">Store Profile</h3>
            </div>
            <div className="grid gap-5 p-6 md:grid-cols-2">
              <Field label="Shop Name">
                <input
                  ...
                  className="w-full rounded-lg border border-slate-200 bg-slate-50 px-4 py-3 text-sm outline-none focus:border-emerald-500"
                />
              </Field>
        ...
        <aside className="rounded-2xl border border-slate-100 bg-white p-6">
          <h3 className="font-bold text-slate-900">Backend Gap</h3>
          ...
          <div className="mt-5 rounded-lg bg-slate-50 p-4 text-xs font-medium text-slate-600">
