...
export default function AdminRole() {
  return (
    <div className="space-y-6 max-w-[1400px] mx-auto pb-10">
      <h2 className="text-2xl font-bold text-text mb-6">About section</h2>
      ...
      <div className="flex flex-col lg:flex-row gap-6 items-start">
         ...
         <div className="w-full lg:w-[35%] flex flex-col gap-6">
            ...
            <div className="bg-surface p-6 rounded-xl border border-border-strong shadow-sm flex flex-col items-center">
              ...
              <h3 className="text-xl font-bold text-text mb-1">Wade Warren</h3>
              <div className="flex items-center gap-2 mb-6">
                <span className="text-muted text-sm font-medium">wade.warren@example.com</span>
              ...
              <p className="text-muted text-sm font-medium mb-4">Linked with Social media</p>
              ...
              <div className="flex items-center justify-center gap-5 mb-6">
                 ...
                 <div className="flex items-center gap-1.5 cursor-pointer hover:opacity-80 transition-opacity">
                    ...
                    <span className="text-xs text-primary font-bold opacity-80 line-through">Linked</span>
                 </div>
                 {/* Facebook */}
                 <div className="flex items-center gap-1.5 cursor-pointer hover:opacity-80 transition-opacity">
              ...
              <button className="flex items-center gap-2 border border-border-strong text-text px-5 py-2.5 rounded-full text-sm font-bold hover:bg-surface transition-colors">
                <Plus className="w-4 h-4 text-muted" /> Social media
              </button>
            </div>
            ...
            <div className="bg-surface p-6 rounded-xl border border-border-strong shadow-sm flex flex-col">
              ...
              <div className="flex flex-col gap-5">
                 <div>
                    ...
                    <a href="#" className="block mt-2 text-xs text-primary font-medium hover:underline">Forgot Current Password? Click here</a>
                 </div>
                 ...
                 <div>
                    <label className="block text-sm font-bold text-text mb-2">Re-enter Password</label>
         ...
         <div className="w-full lg:w-[65%] bg-surface p-8 rounded-xl border border-border-strong shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6 mb-6">
               <div>
                  ...
                  <input type="text" defaultValue="Wade" className="w-full px-4 py-3 bg-surface-alt border border-border-strong rounded-lg text-sm font-bold text-text focus:outline-none focus:border-success focus:ring-1 focus:ring-success" />
               </div>
               <div>
                  <label className="block text-sm font-bold text-text mb-2">Last Name</label>
                  <input type="text" defaultValue="Warren" className="w-full px-4 py-3 bg-surface-alt border border-border-strong rounded-lg text-sm font-bold text-text focus:outline-none focus:border-success focus:ring-1 focus:ring-success" />
               </div>
               <div>
                  <label className="block text-sm font-bold text-text mb-2">Password</label>
                  <div className="relative">
                    <input type="password" defaultValue="************" className="w-full px-4 py-3 bg-surface-alt border border-border-strong rounded-lg text-sm font-bold text-text focus:outline-none focus:border-success focus:ring-1 focus:ring-success tracking-wider" />
                    <button className="absolute right-3 top-1/2 -translate-y-1/2 text-muted hover:text-muted">
                      <EyeOff className="w-4 h-4" />
                    </button>
                  </div>
               ...
               <div>
                  ...
                  <div className="flex bg-surface-alt border border-border-strong rounded-lg overflow-hidden focus-within:border-success focus-within:ring-1 focus-within:ring-success">
                    <input type="text" defaultValue="(406) 555-0120" className="flex-1 px-4 py-3 bg-transparent text-sm font-bold text-text focus:outline-none" />
                    <button className="px-3 border-l border-border-strong flex items-center justify-center gap-1.5 hover:bg-surface-alt transition-colors">
                      ...
                      <svg className="w-3 h-3 text-muted" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path></svg>
                    </button>
                  </div>
               </div>
               <div>
                  <label className="block text-sm font-bold text-text mb-2">E-mail</label>
                  <input type="email" defaultValue="wade.warren@example.com" className="w-full px-4 py-3 bg-surface-alt border border-border-strong rounded-lg text-sm font-bold text-text focus:outline-none focus:border-success focus:ring-1 focus:ring-success" />
               </div>
               <div>
                  <label className="block text-sm font-bold text-text mb-2">Date of Birth</label>
                  <div className="relative">
                    <input type="text" defaultValue="12- January- 1999" className="w-full px-4 py-3 bg-surface-alt border border-border-strong rounded-lg text-sm font-bold text-text focus:outline-none focus:border-success focus:ring-1 focus:ring-success" />
                    <button className="absolute right-3 top-1/2 -translate-y-1/2 text-muted hover:text-muted">
            ...
            <div className="flex flex-col gap-6">
               <div>
                  ...
                  <input type="text" defaultValue="2972 Westheimer Rd. Santa Ana, Illinois 85486" className="w-full px-4 py-3 bg-surface-alt border border-border-strong rounded-lg text-sm font-bold text-text focus:outline-none focus:border-success focus:ring-1 focus:ring-success" />
               </div>
               
               <div>
                  <label className="block text-sm font-bold text-text mb-2">Credit Card</label>
                  <div className="flex relative items-center bg-surface-alt border border-border-strong rounded-lg overflow-hidden focus-within:border-success focus-within:ring-1 focus-within:ring-success">
                    ...
                    <input type="text" defaultValue="843-4359-4444" className="flex-1 px-2 py-3.5 bg-transparent text-sm font-bold text-text focus:outline-none" />
                    <button className="pr-4 pl-2 h-full flex items-center justify-center border-l-transparent text-muted">
               ...
               <div>
                  <label className="block text-sm font-bold text-text mb-2">Biography</label>
                  <div className="relative">
                     <textarea 
                       placeholder="Enter a biography about you" 
                       className="w-full px-4 py-4 bg-surface-alt border border-border-strong rounded-lg text-sm font-medium text-muted focus:outline-none focus:border-success focus:ring-1 focus:ring-success min-h-[120px] resize-none pb-12"
                     ></textarea>
                     <div className="absolute bottom-3 right-3 flex items-center gap-2 text-muted">
                       <button className="hover:text-success transition-colors p-1"><PenTool className="w-4 h-4" /></button>
                       <button className="hover:text-success transition-colors p-1"><Wand2 className="w-4 h-4" /></button>
                     </div>
                  </div>
               </div>
            </div>
