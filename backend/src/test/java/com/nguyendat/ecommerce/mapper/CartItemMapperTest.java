...
class CartItemMapperTest {
    ...
    void toCheckoutItemResponse_shouldIncludeThumbnailUrl() {
        com.nguyendat.ecommerce.dto.internal.CheckoutItem item =
                new com.nguyendat.ecommerce.dto.internal.CheckoutItem();
        item.setVariant(cartItemWithMedia(List.of(media("checkout-thumbnail.jpg", true, 0)))
                .getProductVariant());
        item.setQuantity(2);
