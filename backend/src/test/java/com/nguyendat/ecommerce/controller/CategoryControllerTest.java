...
class CategoryControllerTest {
    ...
    private void assertGetCategoryByIdFails(Long categoryId) throws Exception {
        when(categoryService.getCategoryById(categoryId)).thenThrow(new AppException(ErrorCode.CATEGORY_NOT_FOUND));
        mockMvc.perform(get("/api/v1/admin/categories/{id}", categoryId))
                .andExpect(
    ...
    private void assertDeleteCategoryFails(Long categoryId) throws Exception {
