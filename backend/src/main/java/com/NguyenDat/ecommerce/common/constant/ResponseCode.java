...
public enum ResponseCode {
    ...
    PRODUCT_VARIANT_DELETED(3008, "Product variant deleted successfully"),
    PRODUCT_MEDIA_CREATED(3009, "Product media created successfully"),
    PRODUCT_MEDIA_FETCHED(3010, "Product media fetched successfully"),
    PRODUCT_MEDIA_UPDATED(3011, "Product media updated successfully"),
    PRODUCT_MEDIA_DELETED(3012, "Product media deleted successfully"),
    PRODUCT_MEDIA_REORDERED(3013, "Product media reordered successfully"),
    PRODUCT_VARIANT_STATUS_UPDATED(3014, "Product variant updated successfully"),
