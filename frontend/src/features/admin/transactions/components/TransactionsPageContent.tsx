  ...
  return (
    <div className="space-y-6 max-w-[1400px] mx-auto pb-10">
      ...
      <div className="flex justify-between items-center mb-8">
        <h2 className="text-[22px] font-bold text-slate-900">Transaction</h2>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-6 mb-8">
         ...
         <div className="w-full lg:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex flex-col justify-between">
              <div className="flex justify-between items-start mb-4">
                <h3 className="font-bold text-slate-900 text-[15px]">Total Revenue</h3>
                <button className="text-slate-400 hover:text-slate-600"><MoreVertical className="w-5 h-5" /></button>
              </div>
              <div>
                 <div className="flex items-end gap-2 mb-2">
                   <h2 className="text-[32px] font-extrabold text-slate-900 leading-none">$15,045</h2>
            ...
            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex flex-col justify-between">
              <div className="flex justify-between items-start mb-4">
                <h3 className="font-bold text-slate-900 text-[15px]">Completed Transactions</h3>
                <button className="text-slate-400 hover:text-slate-600"><MoreVertical className="w-5 h-5" /></button>
              </div>
              <div>
                 <div className="flex items-end gap-2 mb-2">
                   <h2 className="text-[32px] font-extrabold text-slate-900 leading-none">3,150</h2>
            ...
            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex flex-col justify-between">
              <div className="flex justify-between items-start mb-4">
                <h3 className="font-bold text-slate-900 text-[15px]">Pending Transactions</h3>
                <button className="text-slate-400 hover:text-slate-600"><MoreVertical className="w-5 h-5" /></button>
              </div>
              <div>
                 <div className="flex items-end gap-2 mb-2">
                   <h2 className="text-[32px] font-extrabold text-slate-900 leading-none">150</h2>
            ...
            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex flex-col justify-between">
              <div className="flex justify-between items-start mb-4">
                <h3 className="font-bold text-slate-900 text-[15px]">Failed Transactions</h3>
                <button className="text-slate-400 hover:text-slate-600"><MoreVertical className="w-5 h-5" /></button>
              </div>
              <div>
                 <div className="flex items-end gap-2 mb-2">
                   <h2 className="text-[32px] font-extrabold text-slate-900 leading-none">75</h2>
         ...
         <div className="w-full lg:w-1/3 bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex gap-4 items-start">
                 ...
                 <div className="flex flex-col justify-center gap-3 py-2">
                    <p className="text-[13px] text-slate-500 font-medium">Status: <span className="text-emerald-500 font-bold ml-1">Active</span></p>
                    <p className="text-[13px] text-slate-500 font-medium">Transactions: <span className="text-slate-900 font-bold ml-1">1,250</span></p>
                    <p className="text-[13px] text-slate-500 font-medium">Revenue: <span className="text-slate-900 font-bold ml-1">$50,000</span></p>
                    <a href="#" className="text-[13px] text-blue-500 font-bold hover:underline mt-1">View Transactions</a>
                 </div>
              </div>
              
              <div className="flex justify-between items-center mt-2">
                 <button className="flex-1 flex items-center justify-center gap-2 border border-slate-200 text-slate-700 py-2.5 rounded-lg text-[13px] font-bold hover:bg-slate-50 transition-colors mr-3">
                   <PlusCircle className="w-4 h-4 text-slate-500" /> Add Card
                 </button>
         ...
         <div className="p-4 border-b border-slate-100 flex items-center justify-between flex-wrap gap-4">
           ...
           <div className="flex items-center gap-3">
             <div className="relative">
               <input type="text" placeholder="Search payment history" className="pl-4 pr-10 py-2.5 border border-slate-200 rounded-lg text-[13px] outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 w-72 bg-slate-50/50 font-medium placeholder:text-slate-400 placeholder:font-normal" />
             ...
             <tbody className="divide-y divide-slate-100 bg-white">
                {mockTransactions.map((row, i) => (
                  <tr key={i} className="hover:bg-slate-50/50 transition-colors group">
                    <td className="px-6 py-4 font-extrabold text-slate-900 text-[13px]">{row.id}</td>
                    <td className="px-6 py-4 text-slate-900 font-medium text-[13px]">{row.name}</td>
                    <td className="px-6 py-4 text-slate-900 font-bold text-[13px]">{row.date}</td>
                    <td className="px-6 py-4 text-slate-900 font-extrabold text-[13px]">{row.total}</td>
                    <td className="px-6 py-4 text-slate-900 font-bold text-[13px]">{row.method}</td>
