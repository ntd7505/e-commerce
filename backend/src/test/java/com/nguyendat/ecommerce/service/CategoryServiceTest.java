...
class CategoryServiceTest {
    ...
    private void assertCreateCategoryFails(String categoryName) {
        categoryRequest = CategoryRequest.builder()
                .name(categoryName)
                .description("Danh muc " + categoryName)
                .parentCategoryId(1L)
                .build();
